...
class SDK {
  ...
  SDK(String clientId, String clientSecret, String enterpriseId, String redirectURL, {this.loginTimeoutDuration, this.logoutTimeoutDuration, this.isSignedInTimeoutDuration, this.resourcePickerTimeoutDuration}) {
    this.clientId = clientId;
    this.clientSecret = clientSecret;
    this.enterpriseId = enterpriseId;
    this.redirectURL = redirectURL;

    _login = new Login(logoutTimeoutDuration: logoutTimeoutDuration, loginTimeoutDuration: loginTimeoutDuration, isSignedInTimeoutDuration: isSignedInTimeoutDuration);
    _resourcePicker = new ResourcePicker(clientId, clientSecret, enterpriseId, redirectURL, resourcePickerTimeoutDuration: resourcePickerTimeoutDuration);
  }
  ...
  Future<String> requestDeviceAccess() async {
    ...
    if(status == "authentication successful") {
      _accessDevices = new AccessDevices(_resourcePicker.accessToken, this.enterpriseId);
    }
    return status;
  }
